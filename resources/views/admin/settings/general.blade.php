                                ...
                                <div class="card-body">
                                    <form method="POST" action="/admin/settings/general">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputzipcode" type="text" class="form-control form-control-lg @error('zip_code') is-invalid @enderror" name="zip_code" value="{{ old('zip_code', $general_setting->zip_code) }}" required autocomplete="zip_code" autofocus placeholder="">
