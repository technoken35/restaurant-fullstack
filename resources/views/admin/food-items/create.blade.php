                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/food-items" class="breadcrumb-link">All Food Categories</a></li>
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/food-items/">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputPrice" type="text" class="form-control form-control-lg @error('price') is-invalid @enderror" name="price" value="{{ old('price')}}" required autocomplete="name" autofocus placeholder="Price">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputImageURL" type="text" class="form-control form-control-lg @error('image_url') is-invalid @enderror" name="image_url" value="{{ old('image_url') }}" autocomplete="image_url" placeholder="Image URL">
