                ...
                <div class="card-body">
                    <form action="#" id="basicform" data-parsley-validate="">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputItemImageUrl" type="text" name="image_url" data-parsley-trigger="change" required="" placeholder="https://www.billys.com/img/burgers.jpg" autocomplete="off" class="form-control">
                        </div>
